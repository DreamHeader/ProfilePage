...
open class ImageEditorController: AnyImageNavigationController {
    ...
    /// Init Photo Editor
    public convenience init(photo resource: EditorPhotoResource, options: EditorPhotoOptionsInfo, delegate: ImageEditorControllerDelegate, fitFrame: CGRect) {
        self.init()
        presetFitFrame = fitFrame
...
extension ImageEditorController {
    ...
    open func update(photo resource: EditorPhotoResource, options: EditorPhotoOptionsInfo) {
        ...
        let rootViewController = PhotoEditorController(photo: resource, options: checkedOptions, delegate: self, fitFrame: presetFitFrame)
...
extension ImageEditorController: PhotoEditorControllerDelegate {
    ...
    func photoEditor(_ editor: PhotoEditorController, didFinishEditing photo: UIImage, isEdited: Bool, stack: PhotoEditingStack) {
        ...
        case .success(let url):
            var result = EditorResult(mediaURL: url, type: .photo, isEdited: isEdited)
            result.mediaRect = stack.cropImageViewFrame
            result.cropRect = stack.cropRect
