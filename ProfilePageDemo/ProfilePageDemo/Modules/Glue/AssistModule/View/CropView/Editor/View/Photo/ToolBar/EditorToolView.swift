...
final class EditorToolView: UIView {
    ...
    private lazy var tipLabel: UILabel = {
       ...
       label.textColor = UIColor.hexColor("#FFFFFF", 1.0)
       return label
    }()
    private(set) lazy var topCoverView: GradientViewer = {
        let view = GradientViewer(frame: .zero)
        view.layer.colors = [
    ...
    private(set) lazy var bottomCoverView: GradientViewer = {
        let view = GradientViewer(frame: .zero)
        view.backgroundColor = UIColor.hexColor("#000000", 1.0)
//        view.layer.colors = [
...
//        view.layer.endPoint = CGPoint(x: 0.5, y: 0)
    ...
    private func setupView() {
        ...
        bottomCoverView.addSubview(self.tipLabel)
        ...
        tipLabel.snp.makeConstraints { make in
            make.left.equalTo(self.bottomCoverView.snp.left).offset(20)
            make.top.equalTo(self.bottomCoverView.snp.top).offset(20)
        }
        ...
        cropToolView.snp.makeConstraints { maker in
            maker.left.right.equalToSuperview()
            maker.top.equalTo(bottomCoverView.snp.top).offset(51)
            maker.height.equalTo(64+26+46)
        }
